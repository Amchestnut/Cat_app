...
@Singleton
class BreedImagesRepositoryImpl @Inject constructor(
    ...
    override fun getAllImagesForThisBreed(breedId: String): Flow<List<BreedImage>> {
    ...
    override suspend fun fetchAndCacheBreedImages(breedId: String) {
